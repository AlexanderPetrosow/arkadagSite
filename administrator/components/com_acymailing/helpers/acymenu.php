...
class acymenuHelper{
	...
	public function myacymailingarea(){
		...
		if(version_compare($currentVersion, $latestVersion, '>=')){
			...
			$menu .= '<div class="acyversion_needtoupdate myacymailingbuttons"><a class="acy_updateversion" href="'.ACYMAILING_REDIRECT.'update-acymailing-'.$config->get('level').'&version='.$config->get('version').'" target="_blank"><i class="acyicon-import"></i>'.acymailing_translation_sprintf('ACY_UPDATE_NOW', $latestVersion).'</a></div>';
		}
