...
class acyupdateHelper{
	...
	function addUpdateSite(){
		...
		$object->location = ACYMAILING_UPDATEMEURL.'updatexml&component=acymailing&version='.$config->get('version').'&level='.$config->get('level');
	...
	function installExtensions(){
		...
		$extensioninfo['mod_acymailing'] = array('AcyMailing 5 module');
