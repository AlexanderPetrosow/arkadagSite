...
console.error('Error in file:/joomla/core/templates/shaper_helixultimate/js/popper.min.js; Error:' + e.message);
};
try {
/*!
...
console.error('Error in file:/joomla/core/templates/shaper_helixultimate/js/bootstrap.min.js; Error:' + e.message);
};
try {
/**
...
console.error('Error in file:/joomla/core/templates/shaper_helixultimate/js/main.js; Error:' + e.message);
};
try {
/*** Stick Menu ***/
jQuery(function($){
...
console.error('Error in file:/joomla/core/templates/shaper_helixultimate/js/custom.js; Error:' + e.message);
};
try {
/**
...
console.error('Error in file:/joomla/core/templates/shaper_helixultimate/js/system/frontediting.js?91386e2433896fe1cc1010af6a2c4bc4; Error:' + e.message);
};
